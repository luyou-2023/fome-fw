...
/**
 * [品牌触发解码器 - Chrysler/克莱斯勒模式]
 * 配置克莱斯勒/道奇/吉普车型的曲轴/凸轮轴触发波形。
 * 包括: Dodge Ram (8齿+凸轮)、Neon 2003 曲轴/凸轮 (双重模式)、
 * Dodge Stratus、Neon 1995、Jeep 18-2-2-2、
 * Jeep XJ 4缸2500、Chrysler NGC 36-2-2、Viper V10 曲轴。
