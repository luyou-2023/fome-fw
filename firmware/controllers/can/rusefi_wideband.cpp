/*
 * [rusefi_wideband.cpp - 宽域氧传感器CAN固件升级]
 * 通过CAN总线对宽域氧传感器控制器进行固件升级。
 * 包含宽域传感器固件镜像数组，通过CAN bootloader协议传输。
 * 关键参数: EFI_WIDEBAND_FIRMWARE_UPDATE开关, wideband_can.h协议, EVT_BOOTLOADER_ACK事件
 */
#include "pch.h"
