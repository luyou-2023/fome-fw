/*
 * [can_imu.cpp - CAN IMU惯性测量单元]
 * 通过CAN总线接收IMU(惯性测量单元)数据，解析加速度和角速度。
 * 使用StoredValueSensor存储横向/纵向/垂直加速度和横摆角速度。
 * 关键参数: SensorType枚举(AccelLat/AccelLon/AccelVert/YawRate), 250ms超时
 */
#include "pch.h"
